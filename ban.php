...
<?php
	$__server->page_embeds->page_title = "DotTube - Banned";
			...
			<div id="content-container">
				...
				<div id="content">
                    <div style="width: 410px;margin: auto;">
                        <h1>Dear User:</h1><br>
                        Our content monitors have determined that your behavior at DotTube <br>has been in
                        violation of our Terms of Service. We have terminated your <br>account. If you make another account, it will also be banned for ban evaision. You are no longer welcome to DotTube<br><br>
