...
<?php
	$__server->page_embeds->page_title = "DotTube - Subscriptions";
					...
					<div class="browse-container ytg-wide ytg-box no-stage browse-bg-gradient">
						<div class="ytg-fl browse-content">
							...
							<div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
                                ...
                                <?php
                                    $stmt = $__db->prepare("SELECT * FROM subscribers WHERE sender = :username ORDER BY id DESC");
                                    ...
                                    <?php while($user = $stmt->fetch(PDO::FETCH_ASSOC)) {  ?> 
                                        <div style="width: 33%;display: inline-block;">
                                            ...
                                            <span style="display: inline-block; vertical-align:top;width: 100px;font-size: 11px;">
                                                ...
                                                <?php echo $__user_h->fetch_subs_count($user['reciever']); ?> subscribers<br>
                                                <?php echo $__user_h->fetch_user_videos($user['reciever']); ?> videos published<br>
                                                <div class="upper-left-section enable-fancy-subscribe-button" style="display: inline-block;">
                                                    <div class="yt-subscription-button-hovercard yt-uix-hovercard">
                                                        <a href="/get/unsubscribe?n=<?php echo htmlspecialchars($user['reciever']); ?>">
                                                            <button 
                                                                href="#" 
                                                                onclick="" 
                                                                title="" 
                                                                id="subscribe-button"
                                                                type="button" 
                                                                class="yt-subscription-button subscribed yt-uix-button yt-uix-button-subscription yt-uix-tooltip" 
