...
<?php
	$__server->page_embeds->page_title = "DotTube - My Videos";
							...
							<div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
								<div class="browse-collection  has-box-ad">
                                    <?php 
                                        ...
                                        $stmt->execute();
                                    ?>
                                <h1 style="display:inline-block;">Video Manager</h1><br>
								<span style="font-size:11px;color:grey;">You currently have <b><?php echo $stmt->rowCount(); ?></b> videos</span><br>
								<hr><br>
                                <?php
